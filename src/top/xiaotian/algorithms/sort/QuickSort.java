...
/**
 * 快速排序
 * 选择数组中某个元素作为基准数，将所有小于基准数的元素移动到其左侧，将大于基准数的元素移动到其右侧。然后继续对子数组进行以上操作，直到数组只剩一个元素为止
 * @author lichuangbo
...
public class QuickSort {
    ...
    // 对数组[l...r]区间进行partition操作：找到一个下标p，交换移动区间内元素，使得arr[l...p-1] < arr[p] && arr[p+1...r] > arr[p]，最终返回下标p
